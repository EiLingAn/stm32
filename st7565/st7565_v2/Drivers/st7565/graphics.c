...
bounding_box_t draw_text(char *string, uint8_t x, uint8_t y, const unsigned char *font, uint8_t spacing) {
	bounding_box_t ret;
	bounding_box_t tmp;
...
bounding_box_t draw_char(uint8_t c, uint8_t x, uint8_t y, const unsigned char *font) {
	unsigned short pos;
